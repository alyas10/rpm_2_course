...
-  **Оценка 5 (отлично)**:\
   Выполнены **все три задания** (по одному варианту из каждого: Задание 1, Задание 2 и Задание 3).\
   В каждом задании реализованы:\
   -- базовый класс,\
   -- производный класс,\
   -- требуемые методы (переопределённые или новые),\
   -- корректная работа наследования.

-  **Оценка 4 (хорошо)**:\
   Выполнены **любые два задания** полностью (например, Задание 1 и Задание 2, или Задание 2 и Задание 3 и т.д.).

-  **Оценка 3 (удовлетворительно)**:\
   Выполнено **одно задание** полностью (любое из трёх).